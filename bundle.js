...
document.addEventListener("DOMContentLoaded", ()=> {
  setupSudoku();
  let selectedCell = __WEBPACK_IMPORTED_MODULE_1_jquery___default()(".sudoku-cell").first();
  let selectedButton = __WEBPACK_IMPORTED_MODULE_1_jquery___default()(".number-button").first();
  let selectedId = parseInt(selectedCell.attr('id'));
  selectedCell.addClass("selected");
  __WEBPACK_IMPORTED_MODULE_1_jquery___default()(".number-button").on("click", (e) => {
    selectedButton.removeClass("selected");
    selectedButton = __WEBPACK_IMPORTED_MODULE_1_jquery___default()(e.currentTarget);
  ...
  __WEBPACK_IMPORTED_MODULE_1_jquery___default()(".sudoku-cell").on("click", (e) => {
    selectedCell.removeClass("selected");
    selectedCell = __WEBPACK_IMPORTED_MODULE_1_jquery___default()(e.currentTarget);
  ...
  document.addEventListener("keydown", (e) => {
    ...
    if (num >= 1 && num <= 9) {
      ...
      selectedCell.removeClass("selected");
      selectedCell = __WEBPACK_IMPORTED_MODULE_1_jquery___default()(`#${selectedId - 1}`);
      selectedId = parseInt(selectedCell.attr('id'));
      selectedCell.addClass("selected");
      ...
      selectedCell.removeClass("selected");
      selectedCell = __WEBPACK_IMPORTED_MODULE_1_jquery___default()(`#${selectedId - 9}`);
      selectedId = parseInt(selectedCell.attr('id'));
      selectedCell.addClass("selected");
...
const setupSudoku = () => {
  __WEBPACK_IMPORTED_MODULE_1_jquery___default()("#board").children().remove();
  let grid = __WEBPACK_IMPORTED_MODULE_1_jquery___default()(document.createElement("div"));
  grid.attr("id", "grid");
  for (let i = 0; i < 9; i++) {
    let box = __WEBPACK_IMPORTED_MODULE_1_jquery___default()(document.createElement("div"));
    for (let j = 0; j < 9; j++) {
      let cell = __WEBPACK_IMPORTED_MODULE_1_jquery___default()(document.createElement("div"));
      let possibilities = __WEBPACK_IMPORTED_MODULE_1_jquery___default()(document.createElement("div"));
      possibilities.addClass("sudoku-cell-possibilities");
      for (let k = 0; k < 9; k++) {
        let possible = __WEBPACK_IMPORTED_MODULE_1_jquery___default()(document.createElement("div"));
  ...
  __WEBPACK_IMPORTED_MODULE_1_jquery___default()("#board").append(grid);
  let numberPanel = __WEBPACK_IMPORTED_MODULE_1_jquery___default()(document.createElement("div"));
  numberPanel.attr("id", "number-panel");
  let number;
  for (let i = 0; i < 10; i++) {
    number = __WEBPACK_IMPORTED_MODULE_1_jquery___default()(document.createElement("div"));
  ...
  __WEBPACK_IMPORTED_MODULE_1_jquery___default()("#board").append(numberPanel);
};
...
class SudokuBoard {
  ...
  render() {
    ...
    for (let i = 0, len = this.cells.length; i < len; i++) {
      cell = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(`#${i}`);
      for (let j = 0, posLen = this.cells[i].possibles.length; j < posLen; j++) {
        __WEBPACK_IMPORTED_MODULE_0_jquery___default()(`#${i}-${j}`).text(this.cells[i].possibles[j] ? j + 1 : "");
      }
